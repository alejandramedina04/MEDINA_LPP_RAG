...
- Go to the GitHub repository: **[https://github.com/alejandramedina04/MEDINA_LPP_Rag/]** and clone it to your machine using `git clone` or the GitHub "Clone" option.  
...
- Start the app with Streamlit, open the local URL shown in your terminal, enter your OpenAI API key in the sidebar, and interact with the assistant as you would in the hosted version.
